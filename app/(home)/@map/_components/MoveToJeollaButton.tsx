...
export default function MoveToJeollaButton({
  ...
  return (
    <div className="absolute z-10 bottom-[110px] left-1/2 -translate-x-1/2 flex flex-col items-center">
      <button
        onClick={onClick}
      ...
      >
        전라남도 지도로 이동하기
        <p className="absolute bottom-full mb-[24px] left-1/2 -translate-x-1/2 whitespace-nowrap rounded-[16px] bg-primary-light px-4 py-[14px] typo-body-1-m">
